...
function getAverageGoals(getFinalscb) {
    const totalGoals = getFinalscb(fifaData).reduce((accumulator, item) => accumulator + item["Home Team Goals"] + item["Away Team Goals"], 0);

    return totalGoals /getFinalscb(fifaData).length;
}
